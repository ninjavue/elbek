      ...
      <header className=" sticky top-0 left-0 right-0 bg-white dark:bg-[#18181b] z-30 px-4 m-2 rounded-lg py-6 border-[3px] dark:border-gray-800 border-gray-200">
        ...
        <Link to="/" className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-4">
            ...
            {!toggle?(
              <Link  to="/login" className="flex items-center gap-2 dark:bg-gray-800 bg-gray-200 px-4 py-2 rounded-lg dark:hover:bg-gray-700 hover:bg-gray-400 transition-all duration-300 dark:text-white text-black text-base font-semibold">
              <span>Kirish</span>
              <LuLogIn size={22} />
            </Link>
            ):(
              <button onClick={() => handleLogout()} className="flex items-center gap-2 dark:bg-gray-800 bg-gray-200 px-4 py-2 rounded-lg dark:hover:bg-red-400 hover:bg-red-400 transition-all duration-300 dark:text-white text-black text-base font-semibold">
              <span>Chiqish</span>
              <LuLogIn size={22} />
            </button>
            )
